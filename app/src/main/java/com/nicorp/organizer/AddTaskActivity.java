...
public class AddTaskActivity extends AppCompatActivity implements ColorPickerDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTimeTextView();
        updateColorItemView();
        setRecurringOptionsVisibility(false); // Initially hidden
    ...
    // Method to toggle recurring options visibility
    private void setRecurringOptionsVisibility(boolean visible) {
        recurringOptionsLayout.setVisibility(visible ? View.VISIBLE : View.GONE);
        startDateTextView.setVisibility(visible ? View.GONE : View.VISIBLE);
    }
